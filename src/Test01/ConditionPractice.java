...
public class ConditionPractice {
	...
	public void practice5() {
		...
		int sum = test1 + test2 + score1;
		
		if((double)test1 * (double)20 / 100.0 + (double)test2 * (double)30 / 100.0 + (double)test2 * (double)30 / 100.0 + score2 < 70) {
			
			System.out.printf("중간 고사 점수(20) : %.1f\n" , (double)test1 * (double)20 / 100.0);
			System.out.printf("기말 고사 점수(30) : %.1f\n" , (double)test2 * (double)30 / 100.0);
			System.out.printf("과제 점수(30) : %.1f\n" , (double)score1 * (double)30 / 100);
			System.out.printf("출석 점수(20) : %.1f\n" , (double)score2);
			System.out.printf("총점 : %.1f\n", ((double)test1 * (double)20 / 100.0 + (double)test2 * (double)30 / 100.0 + (double)test2 * (double)30 / 100.0 + (double)score2));
